...
import visionImg from "../images/ascii-eye.png";
...
export default function Vision() {
  return (
    <section id="Vision" className="bg-[#2d1b55]/10 py-24">
      <div className="container mx-auto grid md:grid-cols-2 xl:gap-8">
        <div className="flex flex-col items-center gap-8">
          <div className="flex flex-col items-start">
            <h2 className="text-3xl md:text-xl xl:text-5xl">Made for mass adoption.</h2>
            <span className="flex items-center gap-2 mt-4">
              <span className={`h-2 w-2 bg-sky-700 rounded-full`}></span>
              LIVE DATA
            </span>
          </div>
          <img src={visionImg} alt="Eye Icon" className="w-4/5" />
        </div>
